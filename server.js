...
// Models where NIM puts thinking inline in delta.content already (with <think> tags)
// and also sends a mirrored delta.reasoning field. We just pass content through and
// strip the redundant reasoning field.
        ...
        lines.forEach(line => {
          ...
          try {
            ...
            if (data.choices?.[0]?.delta) {
              ...
              if (inlineThink) {
                // Kimi: NIM sends thinking inline in delta.content (already has <think> tags)
                // and mirrors it in delta.reasoning. Just delete reasoning and pass content through.
