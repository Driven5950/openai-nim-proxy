...
// Models where NIM embeds <think> tags directly into delta.content during streaming,
// and mirrors the thinking text in a separate delta.reasoning field.
// For these, pass delta.content through untouched and delete delta.reasoning.
        ...
        lines.forEach(line => {
          ...
          try {
            ...
            if (data.choices?.[0]?.delta) {
              ...
              if (inlineThink) {
                // Kimi: thinking is already in delta.content with <think> tags.
                // delta.reasoning is a redundant mirror — delete it and pass content through.
